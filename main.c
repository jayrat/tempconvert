 ...
 */
 ...
 int main()
 {
     float celsius, fahrenheit, degrees; // celsius temp, fahrenheit temp, degrees input
     char op = '\0'; // User Operation Character Input -- initialized to null

     void prompt()
     {
         printf("Enter a temperature in degrees celsius or fahrenheit to have it converted into the other.\n");
